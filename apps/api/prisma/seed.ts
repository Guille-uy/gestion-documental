...
const DOCUMENT_TYPES = [
  ...
  { code: "IT", name: "Instructivo",          prefix: "IT", requiresElaborado: true,  requiresRevisado: false, requiresAprobado: true,  description: "Documento operativo detallado que explica paso a paso cómo realizar una tarea específica." },
  { code: "RG", name: "Registro",             prefix: "RG", requiresElaborado: true,  requiresRevisado: true,  requiresAprobado: true,  description: "Documento que evidencia que una actividad fue realizada. Se completa y archiva." },
  ...
  { code: "PL", name: "Plan",                 prefix: "PL", requiresElaborado: true,  requiresRevisado: true,  requiresAprobado: true,  description: "Documento que establece objetivos, responsables y plazos para una actividad puntual y delimitada en el tiempo." },
  ...
  { code: "IN", name: "Informe",              prefix: "IN", requiresElaborado: true,  requiresRevisado: false, requiresAprobado: false, description: "Documento que comunica resultados, análisis o conclusiones de una actividad realizada." },
  ...
  { code: "CT", name: "Contrato",             prefix: "CT", requiresElaborado: true,  requiresRevisado: false, requiresAprobado: true,  description: "Documento formal que establece los términos, condiciones y responsabilidades acordadas entre la organización y una o más partes externas para la prestación de servicios, provisión de bienes u otras relaciones comerciales." },
];
